    ...
    return (
        <div className="container-fluid p-0 m-0">
            ...
            <div className="row learning-top-margin g-0">
                ...
                <div className="col-md-8 col-lg-8 col-xxl-9 bg-black text-white" id="col-left">
                    {isLessonSelected ? (
                        <div className="vh-100">
                            {/* <div className="d-flex justify-content-around">
                                <button
                                    onClick={handleShowDictation}
                                    className="btn btn-sm btn-secondary rounded-pill text-light"
                                >
                                    Chép chính tả
                                </button>{' '}
                                <button
                            ...
                            {/* {isDictating && (
                                <div className="form-floating">
                                    ...
                                    <label htmlFor="floatingSelect">Mức độ</label>
                                </div>
                            )} */}
                            ...
                            {isDictating ? (
                                ...
                                // render sentences
                                <div className="border border-white rounded-3 m-2 p-2 w-md-75 w-xl-50 mx-md-auto dictating-window">
                                ...
                                <div className="border border-white rounded-3 m-2 p-2 w-md-75 w-xl-50 mx-md-auto tapescript-window">
                            ...
                            <div className="">
                                ...
                                <div className="d-flex justify-content-center">
                                    ...
                                    {playing ? (
                                        <button onClick={pause} type="button" className="btn btn-primary btn-custom">
                                            <i className="fa-solid fa-circle-pause"></i>
                                        </button>
                                    ) : (
                                        <button onClick={play} type="button" className="btn btn-primary btn-custom">
                                            <i className="fa-regular fa-circle-play"></i>
                                        </button>
                                    )}
                                    <button onClick={handleNext} type="button" className="btn btn-primary btn-custom">
